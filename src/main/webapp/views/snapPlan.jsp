			...
			setupFormValidation : function() {
				...
				$("#myForm").validate({
					...
					messages : {
						...
						isEmployee : "Please select isEmployee",
						weeklyIncome : "Please Enter weeklyIncome",
	...
	<div id="page-wrapper">
		<div class="container">
			...
			<form:form name="myForm" class="form-horizontal" id="myForm"
				action="/childPlanRegister" modelAttribute="snapModel" method="POST">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12">
								...
								<%-- 	<div class="form-group">
										<label for="isEmployee" class="col-md-4">Is Working  *</label>
										<div class="col-md-6">
												<form:radiobuttons path="isEmployee" class="form-control" items="${isEmployee}" id="isEmployee"/>
											<form:errors path="isEmployee" class="error" />
										</div>
									</div> --%>
									...
									<div class="form-group">
										<label for="isEmployee" class="col-md-4">Is Working * </label>
										<div class="col-md-6">
											<form:radiobuttons items="${isEmployee}" path="isEmployee" />
											<form:errors path="isEmployee" class="error" />
										</div>
									</div>
									
									<div class="form-group">
										<label for="weeklyIncome" class="col-md-4">Weekly Income *</label>
										<div class="col-md-6">
											<form:input path="weeklyIncome" class="form-control"
												placeholder="Enter weeklyIncome" />
											<form:errors path="weeklyIncome" class="error" />
										</div>
									</div>
