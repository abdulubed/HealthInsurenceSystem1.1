	...
	<div id="page-wrapper">
		<div class="container">
			...
			<form:form name="myForm" class="form-horizontal" id="myForm"
				action="/planSelected" modelAttribute="planRecords" method="POST">
				...
				.				<%-- 	<div class="form-group">
										...
										<div class="col-md-6">
											<form:select path="planName" items="${planNames}" />
									...
									<div class="form-group">
										<label for=role class="col-md-4">Select a Plan </label>
										<div class="col-md-6">
											 <select name="plan.planId" id="planId">
		  <option value="-1">--select--</option>
		  <c:forEach items="${planNames}" var="plan">
		  <option value="${plan.planId}"><c:out value="${plan.planName}"/></option>
		  </c:forEach>
		  </select>
											<form:errors path="planName" class="error" />
										</div>
